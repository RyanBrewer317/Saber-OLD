...
data SyntaxStmt = SFuncDec !String ![String] !STerm
...
data Stmt = FuncDec !String !Int ![(String, Int)] !(Located Term)
...
data TempStmt = TempFuncDec !String !Int ![(TempPolyType, String, Int)] !(TempTypedLoc TempTerm)
